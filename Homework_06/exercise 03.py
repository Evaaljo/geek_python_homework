...
jane = Position("Jane", "Black", "tester", 56000, 20000)
print(jane.get_full_name(), jane.get_total_income())

peter = Position("Peter", "Parker", "developer", 70000, 30000)
print(peter.get_full_name(), peter.get_total_income())
